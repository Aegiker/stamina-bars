...
typedef struct GraphicsContext {
    ...
    /* 0x0008 */ char unk_008[0x04]; // Unused, could this be pointer to "Zelda 3"
    ...
    /* 0x0288 */ char unk_0288[0x10]; // Unused, could this be Zelda 3 ?
                 TwoHeadGfxArena redraw;  // "Zelda 2"
